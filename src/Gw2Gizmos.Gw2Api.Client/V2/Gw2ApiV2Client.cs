...
using Gw2Gizmos.Gw2Api.Client.V2.Clients.Wvw;
...
public class Gw2ApiV2Client : IGw2ApiV2Client
{
    internal Gw2ApiV2Client(HttpClient httpClient)
    {
        ...
        Titles = new TitlesClient(httpClient);
        TokenInfo = new TokenInfoClient(httpClient);
